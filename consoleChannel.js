...
function buildUI() {
    ...
    // CONTROL MECHANISM TO LIMIT EMBEDDING BY REGISTERED SSITES ONLY 
    validateSite();
...
function wrapSVG(apiCallsJS, svg) {
    return "<html>\n<head>\n<title>\n</title>\n</head>\n<body style='padding:5px;margin:0px;' onload='onLoad();animateContext();'>\n" + getApiJS() + apiCallsJS + "<div id='dynamicSVG' style='position:absolute;left:0px;top:0px;width:" + FITWIDTH + "px;height:" + FITHEIGHT + "px;'>" + svg + "\n</div>\n</body>\n</html>";
}
